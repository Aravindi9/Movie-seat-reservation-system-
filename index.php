...
<html lang="en">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Vega "3D" Movie Seat Reservation</a>
       ...
       ?>
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Vega "3D" Movie<br>contact us:0372254018</div></div>
        </footer>
        <!-- Bootstrap core JS-->
